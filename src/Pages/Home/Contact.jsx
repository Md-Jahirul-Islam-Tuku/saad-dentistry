    ...
    <div className=' bg-neutral pb-20 text-info rounded-lg my-20'>
      ...
      <div className='lg:flex lg:justify-around'>
        <div className='lg:flex items-center'>
          <div><img src={icon1} alt="" className='mr-4 h-14 lg:ml-0 ml-[38vw]' /></div>
        ...
        <div className='lg:flex items-center my-10 lg:my-0'>
          <div><img src={icon2} alt="" className='mr-4 h-14 lg:ml-0 ml-[38vw]' /></div>
          <div className='lg:text-left'>
        ...
        <div className='lg:flex items-center'>
          <div><img src={icon3} alt="" className='mr-4 h-14 lg:ml-0 ml-[38vw]' /></div>
          <div className='lg:text-left'>
